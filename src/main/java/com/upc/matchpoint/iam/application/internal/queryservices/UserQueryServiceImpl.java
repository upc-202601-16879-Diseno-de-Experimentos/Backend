package com.upc.matchpoint.iam.application.internal.queryservices;

import com.upc.matchpoint.iam.domain.model.aggregates.User;
import com.upc.matchpoint.iam.domain.model.queries.GetAllUsersQuery;
import com.upc.matchpoint.iam.domain.model.queries.GetUserByIdQuery;
import com.upc.matchpoint.iam.domain.model.queries.GetUserByUsernameQuery;
import com.upc.matchpoint.iam.domain.services.UserQueryService;
