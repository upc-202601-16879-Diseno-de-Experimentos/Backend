...
public interface CoachQueryService {
    ...
    List<com.upc.matchpoint.coaches.domain.model.entities.CoachService> handle(com.upc.matchpoint.coaches.domain.model.queries.GetCoachServicesByCoachIdQuery query);
}
